   ...
   include("data_class.php");
    ?>
        ...
        <div class="innerdiv">
            ...
            <div>Branch:<input type="checkbox" name="branch" value="it"/>CSE<input type="checkbox" name="branch" value="civil"/> PHARMACY<div style="margin-left:80px"><input type="checkbox" name="branch" value="ec"/>EEE<input type="checkbox" name="branch" value="electrical"/>ENGLISH</div>
            </div>   
